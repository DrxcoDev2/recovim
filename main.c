...
int main(int argc, char const *argv[]){
	...
	if(argc == 2){
		/*./recovim <filename> checks if the filename exists already or not, else create new file*/
		...
		/*./recovim i.e. open an empty file, initially the data is in buffer unless the file saved*/
		...
		printf("USAGE: ./recovim <filename> or ./recovim\n");
		bufDestroy(bf);
...
/* #################################### */
	...
	attron(COLOR_PAIR(1));
	mvprintw(ht/2 - 7, wd/2 -  17, "WELCOME TO RECOVIM");
